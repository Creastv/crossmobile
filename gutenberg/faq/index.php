                            ...
                            <svg width="68" height="63" viewBox="0 0 68 63" fill="none"
                                ...
                                <defs>
                                    <clipPath id="clip0_259_3388">
                                        <rect width="67.3125" height="62.1346" fill="white"
                                            transform="translate(0 0.314697)"></rect>
                                    </clipPath>
                                    <clipPath id="clip1_259_3388">
                                        <rect width="21.5745" height="18.1226" fill="white"
                                            transform="translate(23.3008 21.8894)"></rect>
                                    </clipPath>
                                    <clipPath id="clip2_259_3388">
                                        <rect width="64.2317" height="56.2663" fill="white"
                                            transform="translate(1.72559 2.90381)"></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                            <div>
                            ...
                            <?php foreach (get_field('menu') as $single) { ?>
                                <li>
                                    <a class="btn btn-primary"
                                        href="<?php echo $single['link']['url'] ? $single['link']['url'] : '#'; ?>"
                                        title="<?php echo $single['link']['title'] ? $single['link']['title'] : ''; ?>"
                                        target="<?php echo $single['link']['target'] ? $single['link']['target'] : '_self'; ?>">
